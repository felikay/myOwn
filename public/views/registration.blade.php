...
<div class="dropdown" onkeyup="return validate()">
  ...
  <div id="myDropdown" class="dropdown-content">
   ...
   <form action="{{route('register-user')}}" method="post" >
      ...
      <input type="password" name="confirmpassword" id='confirmpassword' placeholder="confirm your password" size="35%"  value="{{old('confirmpassword')}}" onCopy="return false" onDrag="return false" onDrop="return false" onPaste="return false" onkeyup="return validate()">
      ...
      <input type="submit" name="register-user" value="register now" class="btn">
