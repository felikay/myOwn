...
@if($data->count() > 0)
   ...
   <a href="{{url('delete_deactivated/' . $deactivated->id) }}" style="text-decoration: none;" class="delete-btn">Delete</a>
...
@else
<p style="color:red; font-size:30px;"> <span>The are no deactivated accounts</span> </p>
@endif
</section>
