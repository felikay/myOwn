...
<div id="wrapper">
    ...
    @if(Session::has('success'))
       ...
       @endif
       <h3 style="text-align:center; font-size:50px;">Expired auctions</h3>
   ...
   <a href="{{route('expire.status', ['user_id' => $productItem['highestBidder']->product_id , 'status_code' => 'Can Buy']) }}" style="text-decoration: none; background-color:#98777b;" class="delete-btn" >Notify seller</i></a>
