...
@if($data->count() > 0)
   ...
   <h3 style="text-align:center; font-size:50px;">Art Pieces posted for sale</h3>
   ...
   <a href="{{route('product.posted', ['user_id' => $products->id, 'status_code' => 'Not Posted']) }}" style="text-decoration: none; background-color:#8b4513;" class="delete-btn" >Unpost Art Piece</i></a>
...
@endforeach
@else
<p style="color:red; font-size:30px;"> <span>You have no art pieces posted for sale</span> </p>
@endif
